# Generated by Django 4.2.4 on 2024-02-28 13:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('general', '一般ユーザ'), ('store', '店舗ユーザ'), ('admin', '管理者')], max_length=10)),
                ...
                ('user_permissions', models.ManyToManyField(blank=True, related_name='myapp_customuser_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
